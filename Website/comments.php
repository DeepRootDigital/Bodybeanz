<div class="comment-ui">
   <span class="comment-count">
       <img src="<?php echo get_template_directory_uri(); ?>/images/comment-icon.png" alt="phoneinfo"/>
        <?php comments_number( '0', '1', '%' ); ?>
       Comments
   </span>
   <span class="reply-link">
    <img src="<?php echo get_template_directory_uri(); ?>/images/leave-comment-plus.png" alt="phoneinfo"/>
    leave a comment
</span>
<img src="<?php echo get_template_directory_uri(); ?>/images/comment-shadow2.png">
</div>
